...
- а так-же сеттеры и геттеры для сохранения и получения данных из полей класса(поля с подчеркиваниями -\_cards,\_preview - данные получаются с помощью геттеров, а устанавливаются с помощью сеттеров)
